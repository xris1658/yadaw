...
Q_DECLARE_TYPEINFO(ModifiedRhi::QRhiBufferData, Q_RELOCATABLE_TYPE);
namespace ModifiedRhi
{
...
Q_DECLARE_TYPEINFO(ModifiedRhi::QRhiPassResourceTracker::Buffer, Q_RELOCATABLE_TYPE);
namespace ModifiedRhi
{
}
Q_DECLARE_TYPEINFO(ModifiedRhi::QRhiPassResourceTracker::Texture, Q_RELOCATABLE_TYPE);
namespace ModifiedRhi
{
