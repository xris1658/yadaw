...
Q_DECLARE_TYPEINFO(ModifiedRhi::QD3D11ShaderResourceBindings::BoundResourceData, Q_RELOCATABLE_TYPE);
namespace ModifiedRhi
{
...
struct QD3D11SwapChain : public QRhiSwapChain
{
    ...
    bool useFlipMode() const;
    void setFlipMode(bool flipMode);
    void toggleFlipMode();
...
Q_DECLARE_TYPEINFO(ModifiedRhi::QRhiD3D11::TextureReadback, Q_RELOCATABLE_TYPE);
namespace ModifiedRhi
{
}
Q_DECLARE_TYPEINFO(ModifiedRhi::QRhiD3D11::BufferReadback, Q_RELOCATABLE_TYPE);
namespace ModifiedRhi
{
