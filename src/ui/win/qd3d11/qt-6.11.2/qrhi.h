...
Q_DECLARE_TYPEINFO(ModifiedRhi::QRhiDepthStencilClearValue, Q_RELOCATABLE_TYPE);
namespace ModifiedRhi
{

#ifndef QT_NO_DEBUG_STREAM
QDebug operator<<(QDebug, const QRhiDepthStencilClearValue &);
#endif
...
Q_DECLARE_TYPEINFO(ModifiedRhi::QRhiViewport, Q_RELOCATABLE_TYPE);
namespace ModifiedRhi
{

#ifndef QT_NO_DEBUG_STREAM
QDebug operator<<(QDebug, const QRhiViewport &);
#endif
...
Q_DECLARE_TYPEINFO(ModifiedRhi::QRhiScissor, Q_RELOCATABLE_TYPE);
namespace ModifiedRhi
{

#ifndef QT_NO_DEBUG_STREAM
QDebug operator<<(QDebug, const QRhiScissor &);
#endif
...
Q_DECLARE_TYPEINFO(ModifiedRhi::QRhiVertexInputBinding, Q_RELOCATABLE_TYPE);
namespace ModifiedRhi
{

#ifndef QT_NO_DEBUG_STREAM
QDebug operator<<(QDebug, const QRhiVertexInputBinding &);
#endif
...
Q_DECLARE_TYPEINFO(ModifiedRhi::QRhiVertexInputAttribute, Q_RELOCATABLE_TYPE);
namespace ModifiedRhi
{

#ifndef QT_NO_DEBUG_STREAM
QDebug operator<<(QDebug, const QRhiVertexInputAttribute &);
#endif
...
private:
    ...
    friend QDebug operator<<(QDebug, const QRhiVertexInputLayout &);
};

#ifndef QT_NO_DEBUG_STREAM
QDebug operator<<(QDebug, const QRhiVertexInputLayout &);
#endif
...
Q_DECLARE_TYPEINFO(ModifiedRhi::QRhiShaderStage, Q_RELOCATABLE_TYPE);
namespace ModifiedRhi
{

#ifndef QT_NO_DEBUG_STREAM
QDebug operator<<(QDebug, const QRhiShaderStage &);
#endif
...
Q_DECLARE_TYPEINFO(ModifiedRhi::QRhiShaderResourceBinding, Q_PRIMITIVE_TYPE);
namespace ModifiedRhi
{

bool operator==(const QRhiShaderResourceBinding &a, const QRhiShaderResourceBinding &b) noexcept;
bool operator!=(const QRhiShaderResourceBinding &a, const QRhiShaderResourceBinding &b) noexcept;
size_t qHash(const QRhiShaderResourceBinding &b, size_t seed = 0) noexcept;
#ifndef QT_NO_DEBUG_STREAM
QDebug operator<<(QDebug, const QRhiShaderResourceBinding &);
#endif
...
Q_DECLARE_TYPEINFO(ModifiedRhi::QRhiColorAttachment, Q_RELOCATABLE_TYPE);
namespace ModifiedRhi
{
...
Q_DECLARE_TYPEINFO(ModifiedRhi::QRhiTextureSubresourceUploadDescription, Q_RELOCATABLE_TYPE);
namespace ModifiedRhi
{
...
Q_DECLARE_TYPEINFO(ModifiedRhi::QRhiTextureUploadEntry, Q_RELOCATABLE_TYPE);
namespace ModifiedRhi
{
...
Q_DECLARE_TYPEINFO(ModifiedRhi::QRhiTextureCopyDescription, Q_RELOCATABLE_TYPE);
namespace ModifiedRhi
{
...
Q_DECLARE_TYPEINFO(ModifiedRhi::QRhiReadbackDescription, Q_RELOCATABLE_TYPE);
namespace ModifiedRhi
{
...
class QRhiRenderBuffer : public QRhiResource
{
public:
    enum Type {
        DepthStencil,
...
class QRhiShadingRateMap : public QRhiResource
{
public:
...
class QRhiSwapChainRenderTarget : public QRhiRenderTarget
{
public:
    QRhiResource::Type resourceType() const override;
...
protected:
    ...
    friend class QRhiImplementation;
#ifndef QT_NO_DEBUG_STREAM
    friend QDebug operator<<(QDebug, const QRhiShaderResourceBindings &);
#endif
};
...
Q_DECLARE_TYPEINFO(ModifiedRhi::QRhiGraphicsPipeline::TargetBlend, Q_RELOCATABLE_TYPE);
namespace ModifiedRhi
{
...
Q_DECLARE_TYPEINFO(ModifiedRhi::QRhiSwapChainHdrInfo, Q_RELOCATABLE_TYPE);
namespace ModifiedRhi
{

#ifndef QT_NO_DEBUG_STREAM
QDebug operator<<(QDebug, const QRhiSwapChainHdrInfo &);
#endif
...
Q_DECLARE_TYPEINFO(ModifiedRhi::QRhiDriverInfo, Q_RELOCATABLE_TYPE);
namespace ModifiedRhi
{
...
Q_DECLARE_TYPEINFO(ModifiedRhi::QRhiStats, Q_RELOCATABLE_TYPE);
namespace ModifiedRhi
{

#ifndef QT_NO_DEBUG_STREAM
QDebug operator<<(QDebug, const QRhiStats &);
#endif
