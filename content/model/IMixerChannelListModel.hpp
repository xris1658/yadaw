...
public:
    enum Role
    {
        ...
        InstrumentAudioAuxInputs,
        InstrumentAudioAuxOutputs,
...
protected:
    RoleNames roleNames() const override
    {
        static RoleNames ret
        {
            ...
            std::make_pair(InstrumentAudioAuxInputs,            "mclm_instrument_audio_aux_inputs"),
            std::make_pair(InstrumentAudioAuxOutputs,           "mclm_instrument_audio_aux_outputs"),
